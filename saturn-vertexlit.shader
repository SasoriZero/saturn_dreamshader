			...
			Lighting On
				CGPROGRAM
					...
					//	o.color =  float4(ShadeVertexLights(v.vertex, v.normal), 1.0);
						...
						o.uv_MainTex *= distance + (vertex.w*(UNITY_LIGHTMODEL_AMBIENT.a + 8)) / distance / 4;
						o.normal = distance + (vertex.w*(UNITY_LIGHTMODEL_AMBIENT.a + 8)) / distance / 4;
						...
						//Cut out polygons
						if (distance > unity_FogStart.z + unity_FogColor.a)
						{
							o.pos.w = 0;
						}
